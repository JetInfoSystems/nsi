...
public class NsiConfigDict {
    ...
    public String toString() {
        return "NsiConfigDict [name=" + name + ", caption=" + caption
                + ", table=" + table + ", idAttr=" + idAttr.toString()
                + ", parentAttr=" + parentAttr.toString() + ", isGroupAttr="
                + isGroupAttr.toString() + ", ownerAttr="
                + ownerAttr.toString() + ", deleteMarkAttr="
                + deleteMarkAttr.toString() + ", lastChangeAttr="
                + lastChangeAttr.toString() + ", lastUserAttr="
                + lastUserAttr.toString() + ", captionAttrs="
                + captionAttrs.toString() + ", refObjectAttrs="
                + refObjectAttrs.toString() + ", tableObjectAttrs="
                + tableObjectAttrs.toString() + ", fields=" + fields.toString()
